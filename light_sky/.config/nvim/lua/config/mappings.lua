...
map("t", "<M-t>", "<cmd>ToggleTerm 1 direction=horizontal<CR>", { desc = "Toggle terminal", silent = true })
map("n", "<M-t>", ":ToggleTerm 1 direction=horizontal<CR>", { desc = "Toggle terminal", silent = true })
