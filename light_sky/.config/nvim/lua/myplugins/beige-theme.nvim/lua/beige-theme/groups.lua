...
M.setup = function()
	return {
		...
		["@operator"] = { fg = colors.gray1 },

		["@constant"] = { fg = colors.literal },
		["@constant.builtin"] = { fg = colors.literal },
		["@symbol"] = { fg = colors.literal },
		["@constant.macro"] = { fg = colors.literal },
		["@number"] = { fg = colors.literal },
		["@boolean"] = { fg = colors.literal },
		["@float"] = { fg = colors.literal },
		["@field"] = { fg = colors.variable_important },
		["@parameter.reference"] = { fg = colors.variable_important },

		["@character"] = { fg = colors.string },
		["@string"] = { fg = colors.string },
		["@string.regex"] = { fg = colors.bright_green },
		["@string.escape"] = { fg = colors.bright_green },
		...
		["@parameter"] = { fg = colors.variable_important },
		...
		["@text.underline"] = { fg = colors.fg, underline = true }, -- underlined
		...
		["@event"] = { fg = colors.func },
		["@interface"] = { fg = colors.func },
		["@modifier"] = { fg = colors.magenta },
		["@regexp"] = { fg = colors.bright_green },
		["@typeParameter"] = { fg = colors.variable_important },
		["@decorator"] = { fg = colors.yellow },

		-- LSP Semantic (0.9+)
		["@lsp.type.class"] = { fg = colors.class },
		...
		["@lsp.type.parameter"] = { fg = colors.variable_important },
		...
		["@lsp.type.namespace"] = { fg = colors.class },
		["@lsp.type.property"] = { fg = colors.variable_important },
		...
		BufferLineSeparator = { fg = colors.menubg, bg = "#d3d3d3" },
		BufferLineSeparatorVisible = { fg = colors.menubg, bg = "#dbdbdb" },
