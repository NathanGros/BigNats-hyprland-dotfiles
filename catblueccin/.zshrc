...
initialization="clear; fastfetch --config ~/.config/fastfetch/myconfig.jsonc; echo ''"
clearff="clear; fastfetch --config ~/.config/fastfetch/myconfig.jsonc"
...
alias ff='fastfetch --config ~/.config/fastfetch/myconfig.jsonc'
...
# fun packages
alias pipes='pipes.sh -p 6 -Rr 3000'
alias clock='tty-clock -cC 4'
alias matrix='unimatrix -afs 97 -c blue'
...
# other
alias cdcours='cd ~/Documents/scolaire/2025-2026_si3/s6'
